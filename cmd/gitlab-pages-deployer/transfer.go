...
func renameNamespaceJob(message *workers.Msg, projectID int, fullPathWas, fullPath string) {
...
func renameProjectJob(message *workers.Msg, projectID int, pathWas, path, fullPath string) {
...
func moveProjectJob(message *workers.Msg, projectID int, path, fullPathWas, fullPath string) {
...
func removeJob(message *workers.Msg, projectID int, namespacePath, path string) {
