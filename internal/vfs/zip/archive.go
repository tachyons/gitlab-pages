...
func (a *zipArchive) findFile(name string) *zipFile {
...
func (a *zipArchive) Open(ctx context.Context, name string) (vfs.File, error) {
	...
	dataOffset, err := file.cachedDataOffset(&a.fileCacheLock)
	if err != nil {
		return nil, err
	}
